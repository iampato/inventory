...
import (
	...
	endpoint "github.com/iampato/inventory/products/pkg/endpoint"
	http1 "github.com/iampato/inventory/products/pkg/http"
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("products", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
