...
import (
	...
	http1 "github.com/iampato/inventory/supplier/pkg/http"
...
var fs = flag.NewFlagSet("supplier", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("supplier", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
